...
@Configuration
public class ItemaWebMvcConfigurer implements WebMvcConfigurer {
    @Autowired
    private AdminLoginInterceptor adminLoginInterceptor;
    @Autowired
    private ItemaMallLoginInterceptor itemaMallLoginInterceptor;
    @Autowired
    private ItemaMallCartNumberInterceptor itemaCartNumberInterceptor;
    @Autowired
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        // 购物车中的数量统一处理
        registry.addInterceptor(itemaCartNumberInterceptor)
