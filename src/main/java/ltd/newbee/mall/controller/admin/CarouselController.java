...
public class CarouselController {
    ...
    @Resource
    ItemaMallCarouselService itemaMallCarouselService;

    @GetMapping("/carousels")
    public String carouselPage(HttpServletRequest request) {
        request.setAttribute("path", "newbee_mall_carousel");
        return "Itema_mall_carousel";
    }
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(itemaMallCarouselService.getCarouselPage(pageUtil));
    }
    ...
    public Result save(@RequestBody Carousel carousel) {
        ...
        String result = itemaMallCarouselService.saveCarousel(carousel);
    ...
    public Result update(@RequestBody Carousel carousel) {
        ...
        String result = itemaMallCarouselService.updateCarousel(carousel);
        if (ServiceResultEnum.SUCCESS.getResult().equals(result)) {
            return ResultGenerator.genSuccessResult();
        } else {
            return ResultGenerator.genFailResult(result);
    ...
    public Result info(@PathVariable("id") Integer id) {
        Carousel carousel = itemaMallCarouselService.getCarouselById(id);
        if (carousel == null) {
    ...
    public Result delete(@RequestBody Integer[] ids) {
        ...
        if (itemaMallCarouselService.deleteBatch(ids)) {
            return ResultGenerator.genSuccessResult();
        } else {
